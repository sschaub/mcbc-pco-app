...
# URL's
BASE_SERVICE_TYPE_URL = '/services/v2/service_types/{}/plans?filter={}'
...
BASE_MONTHLY_REPORT_URL_PDF = f'https://services.planningcenteronline.com/report_templates/{REPORT_ID_SCHEDULE}/report.pdf?page_size=US-Letter&orientation=Portrait&margin=0.25in'
